...
lld fldr_i = -1, files_r_i = -1, files_c = -1;
chr Folder[1024][300] = {0};
lld curr_ind[1024] = {0};
chr Files_in_d[1024][1024][300] = {0};
chr Files_in_r[1024][300] = {0};
chr sub_in_r[1024][300] = {0};
chr sub_in_d[1024][1024][300] = {0};
chr all_files[10000][300] = {0};
...
/*
gcc file.c `pkg-config fuse --cflags --libs` -lcurl
./a.out  -f store
